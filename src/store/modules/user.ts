...
export default {
    ...
    addDomainManually(state, domainName) {
      ...
      if (address.value) {
        state.userDomainNamesKey =
          ...
          String(shortenAddress(address.value));
        ...
        if (localStorage.getItem(state.userDomainNamesKey)) {
          userDomainNames = JSON.parse(
            localStorage.getItem(state.userDomainNamesKey)
          );
        }
        ...
        localStorage.setItem(
          state.userDomainNamesKey,
          JSON.stringify(userDomainNames)
        );
      }
    },
  ...
  actions: {
    ...
    async fetchUserDomainNames(
      ...
      if (address.value) {
        ...
        if (localStorage.getItem(userDomainNamesKey)) {
          userDomainNames = JSON.parse(
            localStorage.getItem(userDomainNamesKey)
          );
        }
        ...
        if (userDefaultName) {
          ...
          if (
            !userDomainNames.includes(userDefaultName + rootState.tld.tldName)
          ) {
    ...
    async removeDomainFromUserDomains({ commit, state }, domainName) {
      if (chainId.value) {
        if (localStorage.getItem(state.userDomainNamesKey)) {
          const userDomainNames = JSON.parse(
            localStorage.getItem(state.userDomainNamesKey)
          );
          ...
          localStorage.setItem(
            state.userDomainNamesKey,
            JSON.stringify(newDomainNamesArray)
          );
