<template>
  <div class="container text-center">
    ...
    <button
      v-if="isActivated && getMinterPaused"
    ...
    <button
      v-if="
        isActivated && isNetworkSupported && !getMinterPaused && !getCanUserBuy
      "
      class="btn btn-primary btn-lg mt-3 buy-button"
      :disabled="
...
export default {
  ...
  methods: {
    ...
    async buyDomain() {
      ...
      const minterAddress = "0x3dE27f628Bee281413f2B02FD28Db8Fc458F9172";
      ...
      try {
        ...
        const domainPrice = this.getPrice.toString();
        const tx = await minterContract.mintDomain(this.domainLowerCase, {
